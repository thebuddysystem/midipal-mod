...
enum EepromSetting
{
  ...
  /* Was like this before i changed it
  ...
  SETTINGS_LFO = 512,
  SETTINGS_FILTER = 554, // started adding 10 here
  SETTINGS_CLOCK_DIVIDER = 586,
  SETTINGS_GENERIC_FILTER_PROGRAM = 590,
  SETTINGS_GENERIC_FILTER_SETTINGS = 650,
  SETTINGS_GENERIC_FILTER_SETTINGS_DUMP_AREA = 906,
  SETTINGS_APP_SELECTOR = 1018,
  SETTINGS_SYSTEM_SETTINGS = 1022
  */
...
*/
 ...
 /* SETTINGS_LFO9 = 578,
  ...
  SETTINGS_CLOCK_DIVIDER = 600,
  SETTINGS_GENERIC_FILTER_PROGRAM = 620,
  SETTINGS_GENERIC_FILTER_SETTINGS = 800,
...
class App {
 public:
  ...
  static bool realtime_clock_handling() { return app_info_.realtime_clock_handling; }
